...
export default function Content(): JSX.Element {
  ...
  return (
    <body>
      <p>
        <ul>
          <li>I am a software developer and a music producer.</li>
          <li>
      ...
      <section className="flex-row">
        ...
        <a
          ...
          rel="noreferrer"
          target="_blank"
          href="https://github.com/the-domecode"
        >
          DomeCode (2020-21)
        </a>
      </section>
      ...
      <section className="flex-row">
        ...
        <a
          className="display-links"
          href="https://github.com/arthtyagi"
          rel="noreferrer"
          target="_blank"
        >
          Github
        ...
        <a
          className="display-links"
          href="https://www.twitter.com/arthtyagi/"
          rel="noreferrer"
          target="_blank"
        >
          Twitter
        ...
        <a
          className="display-links"
          href="mailto:arth@connectdome.com"
          rel="noreferrer"
          target="_blank"
        >
          Email
      ...
      <section className="flex-row">
        ...
        <a
          className="display-links"
          href="https://open.spotify.com/artist/2Y3z2msSOaboNTc6HCfdsB?si=X4WHP0Y9TLqRP6qngKKhwg&nd=1"
          rel="noreferrer"
          target="_blank"
        >
          Spotify
        ...
        <a
          className="display-links"
          href="https://music.apple.com/ca/artist/trill-bill/1608644758"
          rel="noreferrer"
          target="_blank"
        >
          Apple Music
